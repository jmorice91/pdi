...
{
	if ((i == sim.zonal_x) || (j == sim.zonal_y) || (k == sim.zonal_z)) return;
...
void InitSimData(simdata& sim, MPI_Comm comm)
{
	...
	char* prm_name = "size";
	PDI_multi_expose("damaris_parameter_set", "prm_name", prm_name, PDI_OUT, "prm_buffer", &sim.size, PDI_INOUT, "prm_size", &int_size, PDI_OUT, NULL);
	...
	prm_name = "WIDTH";
	PDI_multi_expose("damaris_parameter_get", "prm_name", prm_name, PDI_OUT, "prm_buffer", &X, PDI_INOUT, "prm_size", &int_size, PDI_OUT, NULL);
	prm_name = "HEIGHT";
	PDI_multi_expose("damaris_parameter_get", "prm_name", prm_name, PDI_OUT, "prm_buffer", &Y, PDI_INOUT, "prm_size", &int_size, PDI_OUT, NULL);
	prm_name = "DEPTH";
	PDI_multi_expose("damaris_parameter_get", "prm_name", prm_name, PDI_OUT, "prm_buffer", &Z, PDI_INOUT, "prm_size", &int_size, PDI_OUT, NULL);
...
void WriteCoordinates(simdata sim)
{
	...
	PDI_multi_expose("damaris_write", "w_var_name", prm_name, PDI_OUT, "XCoord", XCoord, PDI_OUT, NULL);
	prm_name = "coord/y";
	PDI_multi_expose("damaris_write", "w_var_name", prm_name, PDI_OUT, "YCoord", YCoord, PDI_OUT, NULL);
	prm_name = "coord/z";
	PDI_multi_expose("damaris_write", "w_var_name", prm_name, PDI_OUT, "ZCoord", ZCoord, PDI_OUT, NULL);
...
void SimMainLoop(simdata& sim)
{
	...
	if (sim.step % 10 == 0) {
		...
		PDI_multi_expose("damaris_set_position", "pos_var_name", prm_name, PDI_OUT, "pos", pos, PDI_OUT, NULL);
		//damaris_write("zonal_pressure" , sim.zonal_cube);
		PDI_multi_expose("damaris_write", "w_var_name", prm_name, PDI_OUT, "sim.zonal_cube", sim.zonal_cube, PDI_OUT, NULL);

		prm_name = "nodal_pressure";
		//damaris_set_position("nodal_pressure" ,  pos);
		PDI_multi_expose("damaris_set_position", "pos_var_name", prm_name, PDI_OUT, "pos", pos, PDI_OUT, NULL);
		//damaris_write("nodal_pressure" , sim.nodal_cube);
		PDI_multi_expose("damaris_write", "w_var_name", prm_name, PDI_OUT, "sim.zonal_cube", sim.nodal_cube, PDI_OUT, NULL);
...
int main(int argc, char* argv[])
{
	...
	PDI_multi_expose("damaris_start", "is_client", &is_client, PDI_INOUT, NULL);
	...
	if (is_client) {
		...
		PDI_multi_expose("damaris_client_comm_get", "client_comm", &comm, PDI_INOUT, NULL);
