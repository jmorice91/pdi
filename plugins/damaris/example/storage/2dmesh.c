...
void normalWrite(int iteration, int* array)
{
	...
	PDI_multi_expose("damaris_set_position", "pos_var_name", "space", PDI_OUT, "position_space", position_space, PDI_OUT, NULL);

	//damaris_write("space",parray);
	PDI_multi_expose("damaris_write", "w_var_name", "space", PDI_OUT, "parray", parray, PDI_OUT, NULL);
...
void blockWrite(int iteration, int* array)
{
	...
	for (dom = 0; dom < domains; dom++) {
		...
		PDI_multi_expose("damaris_write_block", "wb_var_name", "space", PDI_OUT, "dom", &dom, PDI_OUT, "array", array, PDI_OUT, NULL);
	}
...
int main(int argc, char** argv)
{
	...
	if (is_client) {
		...
		PDI_multi_expose("damaris_client_comm_get", "client_comm", &client_comm, PDI_INOUT, NULL);
		...
		*/
		...
		PDI_multi_expose("damaris_parameter_get", "prm_name", "WIDTH", PDI_OUT, "prm_buffer", &WIDTH, PDI_INOUT, "prm_size", &int_size, PDI_OUT, NULL);
		PDI_multi_expose(
			"damaris_parameter_get",
			"prm_name",
			"domains",
		...
		PDI_multi_expose("damaris_parameter_get", "prm_name", "GX0", PDI_OUT, "prm_buffer", &GX0, PDI_INOUT, "prm_size", &int_size, PDI_OUT, NULL);
		PDI_multi_expose("damaris_parameter_get", "prm_name", "GX1", PDI_OUT, "prm_buffer", &GX1, PDI_INOUT, "prm_size", &int_size, PDI_OUT, NULL);
		PDI_multi_expose("damaris_parameter_get", "prm_name", "GY0", PDI_OUT, "prm_buffer", &GY0, PDI_INOUT, "prm_size", &int_size, PDI_OUT, NULL);
		PDI_multi_expose("damaris_parameter_get", "prm_name", "GY1", PDI_OUT, "prm_buffer", &GY1, PDI_INOUT, "prm_size", &int_size, PDI_OUT, NULL);
		...
		PDI_multi_expose("damaris_parameter_set", "prm_name", "size", PDI_OUT, "prm_buffer", &size, PDI_INOUT, "prm_size", &int_size, PDI_OUT, NULL);
